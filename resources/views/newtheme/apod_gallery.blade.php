        ...
        <div class="row same-height justify-content-center">
            <div class="col-md-12">
                <div class="post-entry text-center">
                    <h3 class="mb-4 text-white">Astrophile: A Passion for the Cosmos</h3>
            ...
            <div class="row blog-entries element-animate">
                <div class="col-md-12 main-content">
                    ...
                    <div class="row" id="responseDateData">
                        @foreach($apodsQuery as $item)
                            <div class="col-md-4 col-sm-6 mb-4">
                                <a href="{{ url('apod_detail') }}/{{ $item->slug }}">
                                    <div class="card">
                                        <img src="{{ $item->url }}" alt="{{ $item->title }}" class="img-fluid rounded card-img-top img-fixed-size">
                                            <div class="card-body">
